    ...
    <nav>
      <div className='header-second'>
        <div className="header-second-msg">
          <p><span>محصولات</span> جدید</p>
          <p><span>برند</span> دلخواه </p>
          <p><span>انتخاب</span> راحت </p>
        </div>
      </div>
      <div className="header-container">
        <Link className="header-main header-section" to="/"><h1>صفحه اصلی</h1></Link>
        <ul className='header-section'>
        <li><Link to="/shop">خرید کردن</Link></li>
          <li><Link to="/">با ما به تماس شود</Link></li>
          <li><Link to="/">در مورد ما</Link></li>
        </ul>
