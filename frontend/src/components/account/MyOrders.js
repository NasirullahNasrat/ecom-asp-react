      ...
      {orders.map((order) => (
        <div className='my-orders-div' key={order.orderID}>
          ...
          <div className='my-orders-about space-between'>
            <ul>
              <li><p className='grey txt'> سفارش #{order.orderID}</p></li>
              <li><p>Placed {formatDateTime(order.dateTime)}</p></li>
            </ul>
            <ul>
              {order.status === 0 && <li><a className='red txt'>لغو</a></li>}
              <li>
                ...
                <div className="cart-item" key={orderItem.orderItemID}>
                  ...
                  <div className="cart-item-about">
                    <div className="cart-item-details">
                      ...
                      <p>اندازه: {orderItem.productSize.size}</p>
                      <p>مقدار: {orderItem.quantity}</p>
                      <p>قیمت: {formatPrice(orderItem.productSize.price)}</p>
                    </div>
                  </div>
                </div>
              </div>
